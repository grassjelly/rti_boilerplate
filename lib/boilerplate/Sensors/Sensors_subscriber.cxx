...
Example subscription of type Sensors automatically generated by 
...
extern "C" int subscriber_main(int domainId, int sample_count)
{
    ...
    DDSTopic *topic = NULL;
    SensorsListener *reader_listener = NULL; 
    ...
    for (count=0; (sample_count == 0) || (count < sample_count); ++count) {
        ...
        printf("Sensors subscriber sleeping for %d sec...\n",
        receive_period.sec);
